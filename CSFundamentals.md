...
- [Goals](https://www.tutorialspoint.com/operating-system-design-goals)
...
- [Scheduler](https://www.geeksforgeeks.org/process-schedulers-in-operating-system/)
- [Process State](https://www.geeksforgeeks.org/states-of-a-process-in-operating-systems/)

### Scheduling algos

- [FCFS](https://www.guru99.com/fcfs-scheduling.html)
- [SJF](https://www.guru99.com/shortest-job-first-sjf-scheduling.html)
- [Longest Remaining time first](https://www.geeksforgeeks.org/longest-remaining-time-first-lrtf-cpu-scheduling-algorithm/)
- [Round Robin](https://www.guru99.com/round-robin-scheduling-example.html)
- [Priority Scheduling](https://www.guru99.com/priority-scheduling-program.html)
- [Multilevel Queue](https://www.geeksforgeeks.org/multilevel-queue-mlq-cpu-scheduling/)

### Threads

- [Types(gfg)](https://www.geeksforgeeks.org/threads-and-its-types-in-operating-system/)
- [Types(JavaT)](https://www.javatpoint.com/threads-in-operating-system)
- [User level & Kernel level](https://www.geeksforgeeks.org/difference-between-user-level-thread-and-kernel-level-thread/)
- [Multithreading](https://www.geeksforgeeks.org/multithreading-in-operating-system/)
- [Zombie processes](https://www.javatpoint.com/what-is-zombie-process)

### Process Synchronization

- [Types of processes-1](https://www.geeksforgeeks.org/introduction-of-process-management/)
- [Types of processes-2](https://www.geeksforgeeks.org/process-synchronization-set-2/)
...
- [Producer consumer problem-1](https://www.geeksforgeeks.org/producer-consumer-problem-using-semaphores-set-1/) 
- [Producer consumer problem-2](https://www.javatpoint.com/producer-consumer-problem-in-os)
- [Dinning Philosopher problem-1](https://codecharms.me/posts/operating-system-the-dining-philosophers-problem)
- [Dinning Philosopher problem-2](https://medium.com/swlh/the-dining-philosophers-problem-solution-in-c-90e2593f64e8)
- [Reader Writer Problem-1](https://www.javatpoint.com/os-readers-writers-problem)
- [Reader Writer Problem-2](https://www.geeksforgeeks.org/readers-writers-problem-set-1-introduction-and-readers-preference-solution/)
- [Locks](https://www.javatpoint.com/os-lock-variable-mechanism)
- [Priority Inversion](https://www.geeksforgeeks.org/priority-inversion-what-the-heck/)

### Deadlock

- [Detection (Conditions)-1](https://www.geeksforgeeks.org/deadlock-detection-recovery/)
- [Detection (Conditions)-2](https://prepinsta.com/operating-systems/deadlock-detection-and-recovery/)
- [Avoidance & Prevention-1](https://www.geeksforgeeks.org/deadlock-prevention/)
- [Avoidance & Prevention-1](https://digitalthinkerhelp.com/deadlock-avoidance-algorithms-in-os-operating-system-must-be-known/)
- [Banker's Algo](https://www.geeksforgeeks.org/bankers-algorithm-in-operating-system-2/)
- [Recovery](https://www.geeksforgeeks.org/recovery-from-deadlock-in-operating-system/)

### File Management

- [Access methods](https://www.geeksforgeeks.org/file-access-methods-in-operating-system/)
- [Allocation methods](https://www.geeksforgeeks.org/file-allocation-methods/)
...
- [Fixed Partitioning](https://www.geeksforgeeks.org/fixed-or-static-partitioning-in-operating-system/)
- [Dynamic partitioning](https://www.geeksforgeeks.org/variable-or-dynamic-partitioning-in-operating-system/)
- [Swapping](https://www.javatpoint.com/swapping-in-operating-system)
- [Paging-1](https://www.geeksforgeeks.org/paging-in-operating-system/ )
- [Paging-2](https://www.studytonight.com/operating-system/paging-in-operating-systems)
- [Segmentation demand paging](https://www.javatpoint.com/os-segmentation)
- [OS demand paging](https://www.javatpoint.com/os-demand-pagings)
...
- [Page table](https://www.javatpoint.com/os-page-table)
- [Inverted page table](https://www.geeksforgeeks.org/inverted-page-table-in-operating-system/)
- [overlay](https://www.geeksforgeeks.org/overlays-in-memory-management/)
- [Page replacement algorithms-1](https://www.geeksforgeeks.org/page-replacement-algorithms-in-operating-systems/)
- [Page replacement algorithms-2](https://www.javatpoint.com/os-numerical-on-lru-fifo-and-optimal)
- [Belady'sAnomaly](https://www.geeksforgeeks.org/beladys-anomaly-in-page-replacement-algorithms/)
...
- [Disks](https://www.geeksforgeeks.org/hard-disk-drive-hdd-secondary-memory/)
- [Disk space management](https://www.geeksforgeeks.org/disk-management-in-operating-system/)
- [Disk Scheduling Algorithms (FCFS, SSTF, SCAN, CSCAN, LOOK) - 1](https://www.geeksforgeeks.org/disk-scheduling-algorithms/)
- [Disk Scheduling Algorithms (FCFS, SSTF, SCAN, CSCAN, LOOK)-2]https://workat.tech/core-cs/tutorial/disk-scheduling-algorithms-in-operating-system-os-ope5ahnn6mhh)
- [Spooling](https://www.javatpoint.com/spooling-in-operating-system)

### Input/Output

- [Device Controller](https://www.javatpoint.com/device-driver-in-operating-system)
- [Device management](https://www.javatpoint.com/device-management-in-operating-system)
...
- https://www.javatpoint.com/parallel-processing
